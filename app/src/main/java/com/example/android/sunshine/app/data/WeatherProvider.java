...
public class WeatherProvider extends ContentProvider {
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        switch (sUriMatcher.match(uri)) {
            ...
            // "location" : 이 부분이 좀 이해가 안돼
            case LOCATION: {
                SQLiteQueryBuilder lLocationQueryBuilder = new SQLiteQueryBuilder();
                lLocationQueryBuilder.setTables(WeatherContract.LocationEntry.TABLE_NAME);
                retCursor = lLocationQueryBuilder.query(mOpenHelper.getReadableDatabase(),
                        projection,
                        selection,
                        selectionArgs,
                        null,
                        null,
                        sortOrder);
                //그렇지 이왕 구현할꺼면 나처럼 위에꺼랑 일관성 있게 구현해야지!
